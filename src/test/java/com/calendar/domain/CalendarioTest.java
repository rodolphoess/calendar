...
public class CalendarioTest {
	...
	public void initialize() {
		eventosAdicionadosList = new ArrayList<Evento>();
		eventosAdicionadosSet = new HashSet<Evento>();
	}
